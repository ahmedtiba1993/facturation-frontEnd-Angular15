...
export class ClientControllerService extends BaseService {
  ...
  save2$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ClientControllerService.Save2Path,
      'post'
    );
    if (params) {
  ...
  findById2$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ClientControllerService.FindById2Path,
      'get'
    );
    if (params) {
  ...
  findAllPaginated1$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ClientControllerService.FindAllPaginated1Path,
      'get'
    );
    if (params) {
  ...
  findAll2$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ClientControllerService.FindAll2Path,
      'get'
    );
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  findAll2(params?: {}, context?: HttpContext): Observable<Array<ClientDto>> {
    return this.findAll2$Response(params, context).pipe(
      map(
        (r: StrictHttpResponse<Array<ClientDto>>) => r.body as Array<ClientDto>
      )
    );
  }
  ...
  delete1$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ClientControllerService.Delete1Path,
      'delete'
    );
    if (params) {
      rb.path('idClient', params.idClient, {});
