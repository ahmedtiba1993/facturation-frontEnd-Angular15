...
export class ProduitControllerService extends BaseService {
  ...
  save$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProduitControllerService.SavePath,
      'post'
    );
    if (params) {
  ...
  findById$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProduitControllerService.FindByIdPath,
      'get'
    );
    if (params) {
   ...
   */
  static readonly FindAllPaginatedPath =
  ...
  findAllPaginated$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProduitControllerService.FindAllPaginatedPath,
      'get'
    );
    if (params) {
  ...
  findAll$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProduitControllerService.FindAllPath,
      'get'
    );
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  findAll(params?: {}, context?: HttpContext): Observable<Array<ProduitDto>> {
    return this.findAll$Response(params, context).pipe(
      map(
        (r: StrictHttpResponse<Array<ProduitDto>>) =>
          r.body as Array<ProduitDto>
      )
    );
  }
  ...
  delete$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      ProduitControllerService.DeletePath,
      'delete'
    );
    if (params) {
      rb.path('idProdtuit', params.idProdtuit, {});
