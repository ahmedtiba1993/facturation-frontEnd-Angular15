...
export class ProduitService {
  ...
  filtre(page: number, size: number , nom : string , code: string , prixMin: number , prixMax: number , etatRemise : boolean):Observable<PageProduitDto>{
    return this.produitService.filtrerProduits({page,size,nom , code , prixMin , prixMax , etatRemise});
  }
