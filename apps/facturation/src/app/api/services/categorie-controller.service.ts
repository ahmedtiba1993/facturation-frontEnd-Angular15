...
export class CategorieControllerService extends BaseService {
  ...
  save3$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      CategorieControllerService.Save3Path,
      'post'
    );
    if (params) {
  ...
  findById3$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      CategorieControllerService.FindById3Path,
      'get'
    );
    if (params) {
   ...
   */
  static readonly FindAllPaginated2Path =
  ...
  findAllPaginated2$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      CategorieControllerService.FindAllPaginated2Path,
      'get'
    );
    if (params) {
  ...
  findAllPaginated2(
    ...
    return this.findAllPaginated2$Response(params, context).pipe(
      map(
        (r: StrictHttpResponse<PageCategorieDto>) => r.body as PageCategorieDto
      )
    );
  }
  ...
  findAll3$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      CategorieControllerService.FindAll3Path,
      'get'
    );
    if (params) {
    }
  ...
  findAll3(
    ...
    return this.findAll3$Response(params, context).pipe(
      map(
        (r: StrictHttpResponse<Array<CategorieDto>>) =>
          r.body as Array<CategorieDto>
      )
    );
  }
  ...
  delete2$Response(
    ...
    const rb = new RequestBuilder(
      this.rootUrl,
      CategorieControllerService.Delete2Path,
      'delete'
    );
    if (params) {
      rb.path('idCat', params.idCat, {});
